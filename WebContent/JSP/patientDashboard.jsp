...
<body class="login">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						...
						<div class="x_content">
							<div>
								<button class="btn btn-primary" id="addPatient" value="addPatient" onclick="return addPatient()">Add Patient</button>
							</div>
							<div id="patientTable" class="table-responsive">
								<table id="patientData" class="table table-striped table-bordered"></table>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="${pageContext.request.contextPath}/js/patientDashboard.js"></script>
