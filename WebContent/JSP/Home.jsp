...
<html lang="en">
<head>
<title>e-Medical Diagnosis</title>
	...
	<div class="container body">
		<div class="main_container">
				...
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath}/patientDashboard"
							target="mainFrame" class="site_title"><i class="fa fa-stethoscope"></i><span
							style="font-size: 18px;"> e-Medical Diagnosis</span></a>
					</div>
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-wheelchair"></i>Patients<span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a
											href="${pageContext.request.contextPath}/patientDashboard"
											target="mainFrame">Patients</a></li>
									</ul></li>
								<li><a><i class="fa fa-table"></i>Reports<span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a
											href="#"
											target="mainFrame">Reports</a></li>
									</ul></li>
							</ul>
						</div>
					</div>
			...
			<div class="right_col" role="main">
				<!-- top tiles -->
				<iframe name="mainFrame" src="${pageContext.request.contextPath}/patientDashboard" width="100%" height="650px"
